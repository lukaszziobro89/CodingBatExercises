package CodingBatExercises.D_Logic;

public class D_Logic_1 {
    /**
    ...
    public boolean love6(int a, int b) {
        if(a == 6 || b == 6){
            return true;
        }else return (Math.abs(a+b) == 6 || Math.abs(a-b) == 6);
    }
    ...
    public boolean nearTen(int num) {
        return (num % 10 == 1 || num % 10 == 2 || num % 10 == 8 || num % 10 == 9);
    }

    /**
     We are having a party with amounts of tea and candy. Return the int outcome of the party encoded as
     0=bad, 1=good, or 2=great. A party is good (1) if both tea and candy are at least 5. However, if either tea
     or candy is at least double the amount of the other one, the party is great (2).
    ...
    public boolean shareDigit(int a, int b) {
        ...
        return ((aFirstDigit == bFirstDigit) || (aFirstDigit == bSecondDigit) ||
    ...
    /**
     ...
     Except if the number is divisible by 3 use "Fizz" instead of the number, and if the number is divisible
     by 5 use "Buzz", and if divisible by both 3 and 5, use "FizzBuzz". Note: the % "mod" operator computes the
    ...
    public int sumLimit(int a, int b) {
        int sumAb = a + b;
        if(String.valueOf(a).length() == String.valueOf(sumAb).length()){
            return sumAb;
        }else {
            return a;
        }
