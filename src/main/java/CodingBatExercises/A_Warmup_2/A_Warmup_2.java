package CodingBatExercises.A_Warmup_2;

public class A_Warmup_2 {
    ...
    public boolean arrayFront9(int[] nums) {
        ...
        for (int i = 0; i <= arrayLength && i < 4 ; i++) {
            if (nums[i] == 9){
                return true;
            }
        }
        ...
        outputString.append(str, 0, 1);
            for (int i = 1; i < str.length(); i++) {
                ...
                if(str.charAt(str.length()-1)=='x'){
                    outputString.append(str, str.length()-1, str.length());
                }
        return outputString.toString();
    }
